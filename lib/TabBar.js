...
showViews = () => {
    if (this.state.selectedPosition == 0) {
        console.log('showedView');
      return   <AddButton/> 
    } else if (this.state.selectedPosition == 1) {
        console.log('showedSecondView');
      return  <CountdownTimer/>
    }else if (this.state.selectedPosition == 2) {
        console.log('showedSecondView');
      return  <HorizontalCalendarList/>
    }else if (this.state.selectedPosition == 3) {
        console.log('showedagendaView');
      return  <AgendaScreen/>
    }
